...
export const sortCals = (clicks) => {
    let sorted;
    const rows = $("#meal-food-table").children('tr').get();
...
export const appendSorted = (cals) => {
    console.log(cals)
    $("#meal-food-table").html('')
    $("#meal-food-table").append(`
    <tr class ='appended'><th>Name</th>
     <th id="cals">Calories</th>
    </tr>`)
    $("#meal-food-table").append(rows)
}
